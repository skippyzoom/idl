...
function efield_graphics, target=target, $
  ...
  case 1 of
     keyword_set(target): begin
        print, "EFIELD_GRAPHICS: Using project dictionary for graphics"
     ...
     keyword_set(imgdata): begin
        print, "EFIELD_GRAPHICS: Using imgdata array for graphics"
  ...
  for ip=0,np-1 do begin
     ...
     if strcmp(colorbar_type,'panel',5) then begin
        print, "EFIELD_GRAPHICS: Panel-specific colorbar not implemented"
     endif
  endfor
